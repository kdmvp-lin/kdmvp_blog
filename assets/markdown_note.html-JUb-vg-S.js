import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as a,g as s}from"./app-CwGtXWoO.js";const t={},i=s(`<h1 id="markdown-note" tabindex="-1"><a class="header-anchor" href="#markdown-note"><span>markdown_note</span></a></h1><p>Markdown是一种纯文本格式的标记语言。通过简单的标记语法，它可以使普通文本内容具有一定的格式。</p><h2 id="一、标题" tabindex="-1"><a class="header-anchor" href="#一、标题"><span>一、标题</span></a></h2><p>在想要设置为标题的文字前面加#来表示 一个#是一级标题，二个#是二级标题，以此类推。支持六级标题。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 这是一级标题
## 这是二级标题
### 这是三级标题
#### 这是四级标题
##### 这是五级标题
